class KinematicScene extends egret.DisplayObjectContainer {
    ...
    private init(){
        ...
        var boxShape = new p2.Box({ width: 100, height: 25 });
        ...
        boxBody.addShape(new p2.Box({ width: 25, height: 25 }));
        ...
        circleBody.addShape(new p2.Circle({ radius: 12.5 }));
